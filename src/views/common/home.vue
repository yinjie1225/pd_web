...
<script>
  ...
  import AddOrUpdate from '../modules/generator/advertisingbusiness-add-or-update.vue'
  export default {
    data () {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: window.SITE_CONFIG['baseUrl'] + '/generator/advertisingbusiness/list',
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: 'http://192.168.1.9:8080/pd_service/generator/advertisingbusiness/delete',
            method: 'post',
