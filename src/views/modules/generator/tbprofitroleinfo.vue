    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.id,scope.row.businessid,scope.row.businessoperatorname)">分润配置</el-button>
...
<script>
  import AddOrUpdate from './tbprofitroleinfo-add-or-update'
  export default {
    data () {
      return {
    ...
    methods: {
      ...
      // 新增 / 修改
      addOrUpdateHandle (id, busId, operatorName) {
        this.addOrUpdateVisible = true
        this.$nextTick(() => {
          this.$refs.addOrUpdate.init(id, busId, operatorName)
        })
      },
      // 详情
