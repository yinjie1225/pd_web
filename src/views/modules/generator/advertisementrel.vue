    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.excelid)">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  ...
  import AddOrUpdate from './advertisementrel-add-or-update'
  export default {
    data () {
    ...
    methods: {
      ...
      // 新增 / 修改
      addOrUpdateHandle (excelid) {
        console.log(excelid)
        this.addOrUpdateVisible = true
        this.$nextTick(() => {
          this.$refs.addOrUpdate.init(excelid)
        })
      },
      // 删除
      deleteHandle (id) {
