  ...
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm"  @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-select v-model="dataForm.roleName" placeholder="所属角色">
          <el-option
      ...
      <el-form-item>
        ...
        <el-select v-model="dataForm.comname" placeholder="所属公司">
          <el-option
  ...
  export default {
    ...
    methods: {
      ...
      deleteHandle (id, username) {
        ...
        this.$confirm(`确定对用户 ` + username + ` 进行[${'删除'}操作?`, '提示', {
